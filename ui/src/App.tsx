...
import { Plus, Loader2, Code, LayoutTemplate, ChevronDown, Sparkles, Settings, Moon, Sun } from 'lucide-react'
...
function App() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      // C : Toggle code mode (when project selected)
      ...
      if (e.key === 'Escape') {
        ...
        } else if (showAiFeatureChat) {
          setShowAiFeatureChat(false)
  ...
  }, [selectedProject, showAddFeature, showAiFeatureChat, showExpandProject, selectedFeature, debugOpen, debugActiveTab, assistantOpen, features, showSettings, showKeyboardHelp, isSpecCreating, viewMode])
